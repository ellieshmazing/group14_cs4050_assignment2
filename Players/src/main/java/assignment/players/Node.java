...
public class Node {
	...
	// default constructor
	public Node() {
		this(new PlayerRecord()); // storing null Record objects
	}

	public Node(PlayerRecord data) {
		this(data, null, null);
	}

	public Node(PlayerRecord data, Node leftChild, Node rightChild) {
		_data = data;
	...
	public void setData(PlayerRecord data) {
		_data = data;
	}
